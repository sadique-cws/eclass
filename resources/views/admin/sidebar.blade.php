<div class="admin-sidebar">
    ...
    <a href="{{ route('course.index') }}" class="sidebar-item {{ request()->routeIs('admin.courses') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.manageAdmission') }}" class="sidebar-item {{ request()->routeIs('admin.manageAdmission') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.manageStudent') }}" class="sidebar-item {{ request()->routeIs('admin.manageStudent') ? 'active' : '' }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
        <span>Manage Students</span>
    </a>
    <a href="" class="sidebar-item {{ request()->routeIs('admin.payments') ? 'active' : '' }}">
    ...
    <a href="" class="sidebar-item {{ request()->routeIs('admin.batches') ? 'active' : '' }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg>
        <span>Manage Batches</span>
    </a>
    <a href="" class="sidebar-item {{ request()->routeIs('admin.settings') ? 'active' : '' }}">
    ...
    <a href="{{ route('public.logout') }}" class="sidebar-item logout">
